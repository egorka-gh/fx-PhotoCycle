	...
	public class PrintManager extends EventDispatcher{
		...
		*/
		...
		public function post(printGrps:Vector.<Object>,lab:LabBase):void{
			...
			lab.addEventListener(PostCompleteEvent.POST_COMPLETE_EVENT,onPostComplete);
		...
		private function onPostComplete(e:PostCompleteEvent):void{
		...
		private function deleteNextFolder():void{
			...
			if(currentLab.type_id==SourceType.LAB_XEROX){
			...
			var prefix:String=SourceProperty.getProperty(currentLab.type_id,SourceProperty.HF_PREFIX);
			var sufix:String=SourceProperty.getProperty(currentLab.type_id,SourceProperty.HF_SUFIX_READY);
			var path:String=currentLab.hotFolder.url+File.separator+prefix+currentLab.orderFolderName(pg)+sufix;
