...
package com.photodispatcher.model.mysql.services {
    ...
    public class XReportServiceBase extends Component {
        ...
        public function XReportServiceBase() {
            super();
        }
        ...
        public function getGroups(arg0:int, resultHandler:Object = null, faultHandler:Function = null):AsyncToken {
            if (faultHandler != null)
                return callProperty("getGroups", arg0, resultHandler, faultHandler) as AsyncToken;
            else if (resultHandler is Function || resultHandler is ITideResponder)
                return callProperty("getGroups", arg0, resultHandler) as AsyncToken;
            else if (resultHandler == null)
                return callProperty("getGroups", arg0) as AsyncToken;
            else
                throw new Error("Illegal argument to remote call (last argument should be Function or ITideResponder): " + resultHandler);
        }    
        
        public function getPrintFormFieldItems(resultHandler:Object = null, faultHandler:Function = null):AsyncToken {
            if (faultHandler != null)
                return callProperty("getPrintFormFieldItems", resultHandler, faultHandler) as AsyncToken;
            else if (resultHandler is Function || resultHandler is ITideResponder)
                return callProperty("getPrintFormFieldItems", resultHandler) as AsyncToken;
            else if (resultHandler == null)
                return callProperty("getPrintFormFieldItems") as AsyncToken;
            else
                throw new Error("Illegal argument to remote call (last argument should be Function or ITideResponder): " + resultHandler);
        }    
        
        public function getPrintFormParameters(resultHandler:Object = null, faultHandler:Function = null):AsyncToken {
            if (faultHandler != null)
                return callProperty("getPrintFormParameters", resultHandler, faultHandler) as AsyncToken;
            else if (resultHandler is Function || resultHandler is ITideResponder)
                return callProperty("getPrintFormParameters", resultHandler) as AsyncToken;
            else if (resultHandler == null)
                return callProperty("getPrintFormParameters") as AsyncToken;
            else
                throw new Error("Illegal argument to remote call (last argument should be Function or ITideResponder): " + resultHandler);
        }    
        
        public function getPrintForms(resultHandler:Object = null, faultHandler:Function = null):AsyncToken {
            if (faultHandler != null)
                return callProperty("getPrintForms", resultHandler, faultHandler) as AsyncToken;
            else if (resultHandler is Function || resultHandler is ITideResponder)
                return callProperty("getPrintForms", resultHandler) as AsyncToken;
            else if (resultHandler == null)
                return callProperty("getPrintForms") as AsyncToken;
            else
                throw new Error("Illegal argument to remote call (last argument should be Function or ITideResponder): " + resultHandler);
        }    
